...
const IncreaseBalance = () => {
	...
	const increaseAmountChangeHandler = (e: ChangeEvent<HTMLInputElement>) => {
		setIncreaseAmount(+e.target.value);
	};
	const amountOptionHander = (amount: number) => {
	...
	return (
		<Box>
			...
			<div className={styles.increaseForm}>
				...
				<Button disabled type="secondary">پرداخت آنلاین</Button>
			</div>
		</Box>
	);
};
